...
define([
    'jquery',
    'RLTSquare_Quickview/js/quickViewRenderer',
    'domReady!RLTSquare/Quickview/view/base/web/js'
], function ($) {

    $.widget('mage.rltsquareInitQuickView', {
        options: {
            mode: null,
            isAdminArea: null,
            config: null,
        ...
        execQuickView: function () {
            this.element.rltsquareRenerQuickViewButton(this.options.config);
        },
    ...
    return $.mage.rltsquareInitQuickView;
});
