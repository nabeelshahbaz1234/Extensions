define([
    ...
    $.widget('mage.rltsquareRenerQuickViewButton', {
        options: {},
        textElement: null,
        parent: null,
        ...
        _create: function () {
            ...
            if (this.element.attr('rltsquare-quickview-js-observed')) {
                return;
            }
            this.element.attr('rltsquare-quickview-js-observed', 1);
            ...
            this.textElement = this.element.find('.rltsquare-quickview-text');
        ...
        setButtonPosition: function () {
            var className = 'rltsquare-quickview-position-' + this.options.position
            ...
            if (wrapper.length) {
                ...
                var parent = this.element.parent();
                if (parent.hasClass('rltsquare-quickview-position-wrapper')) {
                    parent.parent().append(this.element);
                }

                this.element.wrap("<div class='" + className + ' rltsquare-quickview-position-wrapper' + "'></div>");
    ...
    return $.mage.rltsquareRenerQuickViewButton;
});
