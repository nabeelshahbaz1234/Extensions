define([
    ...
    $.widget('mage.rltsquareQuickViewAbstract', {
        options: {
            closeSeconds: 10,
            showMiniCart: true,
        ...
        displayContent: function (event, element, options) {
            ...
            var url = optionsConf.baseUrl + 'rltsquare_quickview/index/updatecart';
    ...
    $.widget('mage.rltsquareQuickViewDefault', $.mage.rltsquareQuickViewAbstract, {
        _create: function () {
            var self = this,
            ...
            $(function () {
                ...
                button.bind('click', params, function (e) {
                    ...
                    $.mage.rltsquareQuickViewAbstract.prototype.displayContent(e, button, options);
